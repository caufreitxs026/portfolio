...
// Como este arquivo já é 'use client', o Next.js permite o ssr: false aqui sem erros de build
...
export default function ClientEffects() {
  ...
  // Evita qualquer tentativa de renderizar componentes pesados no servidor
